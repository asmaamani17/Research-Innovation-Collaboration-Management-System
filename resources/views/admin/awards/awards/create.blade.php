                ...
                <div class="grid grid-cols-12 gap-8">
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-6">
                        <div>
                            ...
                            <input list="staff_list" name="staff_id" required placeholder="Search staff member..."
                        ...
                        <div>
                            ...
                            <input list="project_list" name="project_id" required placeholder="Search project..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
                            <datalist id="project_list">
                                @foreach($projects as $p)
                                    <option value="{{ $p->id }}">{{ $p->project_id }} - {{ $p->project_title }}</option>
                                @endforeach
                            </datalist>
                            @error('project_id')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                ...
                <div class="grid grid-cols-12 gap-8">
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-6">
                        <div>
                            ...
                            <input list="award_name_list" name="award_name" required placeholder="Search award name..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
                        ...
                        <div>
                            ...
                            <input list="award_level_list" name="award_level" required placeholder="Search award level..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
                        ...
                        <div>
                            ...
                            <input list="award_type_list" name="award_type" required placeholder="Search award type..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
                ...
                <div class="grid grid-cols-12 gap-8">
                    ...
                    <div class="col-span-12 lg:col-span-8 space-y-6">
                        <div>
                            ...
                            <input list="event_list" name="event_id" required placeholder="Search event..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
                        ...
                        <div>
                            ...
                            <input list="exhibition_level_list" name="event_exhibition_level" required placeholder="Search exhibition level..."
                                class="w-full px-4 py-3 border border-divider-subtle/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
