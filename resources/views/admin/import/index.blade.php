        ...
        <div class="bg-white border border-divider-subtle/30 rounded-xl overflow-hidden shadow-sm">
            ...
            <div class="px-8 py-6 border-b border-divider-subtle/30">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="{{ route('admin.import.template', ['type' => 'Template_RD8_1_New']) }}"
                        class="flex items-center gap-3 p-4 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors border border-blue-200">
                        <span class="material-symbols-outlined text-blue-600 text-2xl">download</span>
                        <div>
                            <p class="font-semibold text-text-main text-sm">Template_RD8_1_New</p>
                            <p class="text-xs text-divider-subtle">Download Template_RD8_1_New format</p>
                        </div>
                    </a>
            ...
            <div class="px-8 py-6 border-b border-divider-subtle/30">
                ...
                <div class="space-y-3">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-sm text-text-main/80">Download the appropriate template for the data you want to
                            import.</p>
                    </div>
                    <div class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-primary text-xl mt-0.5">looks_two</span>
                        <p class="text-sm text-text-main/80">Fill in the CSV file with your data following the template
                            format exactly.</p>
                    </div>
                    <div class="flex items-start gap-3">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-sm text-text-main/80">Wait for the import to complete. The progress bar will show the
                            status.</p>
                    </div>
                ...
                <form id="importForm" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="type" id="dataType" required
                            ...
                            <option value="Template_RD8_1_New">Template_RD8_1_New</option>
                            <option value="Template_RD8_New">Template_RD8_New</option>
                            <option value="awards">Awards (Simple)</option>
                            <option value="events">Events (Simple)</option>
                            <option value="faculties">Faculties (Simple)</option>
                            <option value="projects">Projects (Simple)</option>
                            <option value="staff">Staff (Simple)</option>
                        </select>
                    </div>
                    <div>
